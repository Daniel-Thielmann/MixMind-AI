      ...
      >
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
          <a href="/" className="flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-primary to-primary-dark text-xs font-bold text-background shadow-lg shadow-primary/20">
              M
            </div>
          ...
          <nav className="hidden items-center gap-1 md:flex">
            {NAV_LINKS.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className="flex items-center gap-1.5 rounded-lg px-3 py-2 text-sm text-text-secondary transition-colors duration-300 hover:bg-card hover:text-text"
              >
              ...
              <nav className="flex flex-col gap-1 p-3">
                {NAV_LINKS.map((link) => (
                  <a
                    ...
                    className="flex items-center gap-2 rounded-lg px-3 py-2.5 text-sm text-text-secondary transition-colors hover:text-text hover:bg-card"
                  >
                    <link.icon className="h-4 w-4" />
                    {link.label}
                  </a>
